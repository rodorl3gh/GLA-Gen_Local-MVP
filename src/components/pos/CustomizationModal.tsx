        ...
        <div className="relative bg-white rounded-2xl w-full max-w-sm shadow-2xl animate-scale-in max-h-[90vh] overflow-y-auto">
          ...
          {product.description && (
            <div className="px-4 pt-3 pb-1">
              <div className="p-2.5 rounded-xl bg-gray-900 text-white flex items-start gap-2">
                <svg className="w-3.5 h-3.5 text-white/50 mt-0.5 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <div>
                  <p className="text-[11px] leading-relaxed text-gray-200">{product.description}</p>
                  <p className="text-[9px] text-gray-400 mt-0.5 uppercase tracking-wider">{product.category}</p>
                </div>
              </div>
            </div>
          )}
